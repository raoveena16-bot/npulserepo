...
public class PatientAprrovalPage {
	WebDriver driver;
	private By patienUsernameLocator = By.name("username");
	private By patientPasswordLocator = By.name("password");
	
	public PatientAprrovalPage(WebDriver driver) {
		
		this.driver = driver;
	}
	
	public String getErrorMessage() {
		WebElement errorMessage = driver.findElement(By.xpath("//p[text()='Invalid username or password']"));
